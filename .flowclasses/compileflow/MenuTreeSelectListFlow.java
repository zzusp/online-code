...
public class MenuTreeSelectListFlow implements ProcessInstance {
    ...
    public Map<String, Object> execute(Map<String, Object> _pContext) throws Exception {
        ...
        //ServiceTask
        result = ((JavaExecutor)ObjectFactory.getInstance("com.alibaba.compileflow.extension.executor.JavaExecutor")).execute((Map)DataType.transfer(flowVars, Map.class), (Map)DataType.transfer(vars, Map.class), "Activity_09t0yok", "菜单树下拉查询");
