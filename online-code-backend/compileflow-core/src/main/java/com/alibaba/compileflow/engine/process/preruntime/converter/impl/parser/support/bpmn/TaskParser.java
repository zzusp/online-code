...
public class TaskParser extends AbstractBpmnElementParser<Task> {
    ...
    protected Task doParse(XMLSource xmlSource, ParseContext parseContext) throws Exception {
        ...
        actionHandle.setClazz("com.alibaba.compileflow.extension.executor.JavaExecutor");
    ...
    public String getName() {
        return BpmnModelConstants.BPMN_ELEMENT_TASK;
    }
